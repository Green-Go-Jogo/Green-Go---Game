...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Maio-2023 às 21:53
...
(1, 'Capim limão', 'Cymbopogon citratus', 'Erva-príncipe ou capim-cidreira também conhecido por capim-santo ou capim-limão, ou erva cidreira de capim é uma planta herbácea da família Poaceae, nativa das regiões tropicais da Ásia, especialmente da Índia.', '../public/capim-limao.jpeg\"', 0, 0, 0, 0, 0, 0, 3),
(12, 'asyidvadvhja', 'wdjnasdjkas', '<p>hibwdhasbdhjasbdas</p>', '../public/6a45219f2aefaf6ba0ffc784ee0f5337.jpg', 0, 0, 1, 0, 1, 0, 10),
(13, 'aa', 'aa', '<p>aa</p>', '../public/19bf75f9307ff428b42ac8256fb28816.png', 0, 0, 0, 0, 1, 0, 21);
...
(36, 2, 0, 2313, '../../public/plantas/2f3e44c9b2ad4f616f07e54ce104690e.jpeg', 131, '', 'Cactus', '<p>aaa</p>');
...
--
ALTER TABLE `planta`
  MODIFY `idPlanta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `planta`
  ADD CONSTRAINT `fkZona` FOREIGN KEY (`idZona`) REFERENCES `zona` (`idZona`);
