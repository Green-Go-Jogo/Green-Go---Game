...
-- Tempo de geração: 23/11/2023 às 20:54
...
(9, 'Cacto', '#8ae600', '../../public/icon/cacto_icon.png'),
...
(104, '2023-11-20 09:21:05', '2023-11-20 09:21:05', 2, 60, 'Amanda esteve aqui AGAIN', '123', 11),
(126, '2023-11-20 10:37:14', '2023-11-20 10:37:14', 2, 30, 'Amanda esteve aqui 4', '12345', 11),
(127, NULL, NULL, 3, 15, 'Amanda esteve aqui ( de novo )', '12345', 11),
(128, '2023-11-22 21:09:36', '2023-11-22 21:09:36', 2, 12, 'equipes teste', '12345', 22);
...
(89, 37, 24, 1306, '../../public/plantas/b0076c64a2db5f99cb483a69a9068505.jpeg', 25, '../../public/qrcode/qrcode_1306.png', 'Azaléia', '<p>A azaleia, conhecida pelo nome científico Rhododendron simsii, é um arbusto de folhagem perene que produz flores vistosas e coloridas, em tons que variam do branco ao rosa, vermelho e lilás. É uma planta muito apreciada como ornamental devido à beleza de suas flores e folhagem. Vale ressaltar que as folhas da azaleia são tóxicas se ingeridas, por isso é importante evitar o consumo pelos animais de estimação e crianças.</p>', 22),
...
(91, 37, 22, 1506, '../../public/plantas/62e45a00d9626831aae860553793089d.jpeg', 35, '../../public/qrcode/qrcode_1506.png', 'Ipê roxo', '<p>O ip&ecirc; roxo, cujo nome cient&iacute;fico &eacute; Handroanthus impetiginosus, &eacute; uma &aacute;rvore de porte m&eacute;dio a grande, nativa do Brasil. Possui flores de cor roxa intensa, que surgem em cachos volumosos, criando um espet&aacute;culo visual impressionante. Suas flores s&atilde;o conhecidas por atrair polinizadores, como abelhas e borboletas. O ip&ecirc; roxo &eacute; amplamente valorizado por sua beleza ornamental e resist&ecirc;ncia, sendo utilizado em paisagismo e reflorestamento.</p>\r\n', 22),
...
(144, 47, 46, 6388, '../../public/plantas/47ddc333d6c79c97567c0ba8f969631f.jpg', 25, '../../public/qrcode/qrcode_6388.png', '', '<p>Aqui estará a história dessa planta em nosso campus.</p><p>&nbsp;</p><figure class="image"><img src="../../public/descricao/foz-vertical.png"></figure><p>&nbsp;</p>', 23),
...
(40, 'Annye Miyuki Furuti', 'Outro', 'Ensino Médio', 'Annye', 'annye.furuti@gmail.com', '$2y$10$foCck.R1HzE5hFUcjPDZ6.GRSBbY0ly0.jRWtb6Mb7ZBhfIB0pNLq', 2),
...
(16, 'Zona Deserto', 0, NULL, 11),
(34, 'Zona 01', 1, 80, 22),
(35, 'Zona 02', 1, 45, 22),
(36, 'Zona 03', 2, 150, 22),
(37, 'Zona Sepin', 4, 170, 22),
(46, 'Zona IFPR', 0, NULL, 22),
(47, 'Trilha MIPEEC', 14, 365, 22),
...
--
ALTER TABLE `equipe`
  MODIFY `idEquipe` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT de tabela `especie`
--
ALTER TABLE `especie`
  MODIFY `idEspecie` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT de tabela `partida`
--
ALTER TABLE `partida`
  MODIFY `idPartida` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=129;
--
-- AUTO_INCREMENT de tabela `partida_equipe`
--
ALTER TABLE `partida_equipe`
  MODIFY `idPartidaEquipe` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=171;
--
-- AUTO_INCREMENT de tabela `partida_usuario`
--
ALTER TABLE `partida_usuario`
  MODIFY `idPartidaUsuario` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=108;
--
-- AUTO_INCREMENT de tabela `partida_zona`
--
ALTER TABLE `partida_zona`
  MODIFY `idPartidaZona` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=147;
--
-- AUTO_INCREMENT de tabela `planta`
--
ALTER TABLE `planta`
  MODIFY `idPlanta` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=164;
--
...
--
ALTER TABLE `zona`
  MODIFY `idZona` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=50;
--
