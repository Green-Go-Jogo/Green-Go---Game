...
if (empty($email) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    $exist = $usuarioCont->checarEmailExiste($email);
    if ($exist) {
        $erroCampo3 = "O e-mail já está cadastrado no sistema";
    }
}

if (empty($senha) || strlen($senha) < 5) {
    $erroCampo4 = "A senha deve conter pelo menos 5 caracteres.";
}
...
$respostaCampo7 = $erroCampo7 ? $erroCampo7 : "";
  ...
  $respostas = array("campo1" => $respostaCampo1,  
