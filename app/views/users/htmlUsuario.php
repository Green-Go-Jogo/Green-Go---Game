...
<style>
    ...
    td {
        ...
        padding: 8px;
        width: 25%;
        /* Definindo a largura para 25% para cada coluna */
    }
...
class UsuarioHTML
{
    public static function desenhaUsuario($usuarios)
    {
        ...
        echo "<thead>";
        echo "<tr>";
        echo "<th colspan='5' class='text-center'>LISTA DE USUÁRIOS</th>";
        echo "</tr>";
        echo "<tr>";
        ...
        foreach ($usuarios as $usuario) {
            ...
            if ($nivelAcesso != $usuario->getTipoUsuario() && !$isCurrentUser) {
            ...
            echo "</td>";
            echo "<td class='tb_conteudo'>";
            echo "<a class='btn' id='excluir' href='excluirConta.php?idUsuario=" . $usuario->getIdUsuario() . "' onclick='return confirm(\"Tem certeza que deseja excluir o usuário ".$usuario->getNomeUsuario()."? Essa ação é irreversível.\")'>Excluir</a>";
            echo "</td>";
            echo "</tr>";
        }
