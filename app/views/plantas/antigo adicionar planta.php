                ...
                <div class="row justify-content-md-left">
                    ...
                    <div id="corpo-registro">
                        ...
                        //INÍCIO DO FORMULÁRIO
                            ...
                            <div class="w-100"></div>
                            <input type="text" name="Nome_Social" class="form-control" id="txtNome" aria-describedby="nome-cadastro">
                            <div class="w-100"></div>
                            <label for="formtexto" id="txtCodigo">Código numérico</label>
                            <div class="w-100"></div>
                            <input type="number" name="Cod_Numerico" class="form-control" id="txtCodigo" aria-describedby="nome-cadastro">
                            <div class="w-100"></div>
                            ...
                            <div class="w-100"></div>
                            <input type="number" name="Pontuacao" class="form-control" id="Pontuacao" aria-describedby="nome-cadastro">
                            <div class="w-100"></div>
